...
<!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Detail Aktivasi</h1>
                   ...
                   <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col">
                                    <h6 class="m-0 font-weight-bold text-primary">Detail Aktivasi <?=$list['no_pembayaran']?></h6>
                                </div>
                        ...
                        <div class="card-body">
                           <div class="row">
                               <div class="col-12 col-md-6 mb-2">
                                   Kode Aktivasi
                                   <input type="text" class="form-control" Readonly value="<?=$list['kode']?>">
                               </div>
                                <div class="col-12 col-md-6 mb-2">
                                   Website
                                   <input type="text" class="form-control" Readonly value="<?=$list['web']?>">
                               </div>
                               <div class="col-12 col-md-6 mb-2">
                                   Kategori 1
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori']?>">
                               </div>
                               <div class="col-12 col-md-6 mb-2">
                                   Kategori 2
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori1']?>">
                               </div>
                               
                                <div class="col-12 col-md-6 mb-2">
                                   Kategori 3
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori2']?>">
                               </div>
                                <div class="col-12 col-md-6 mb-2">
                                   Kategori 4
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori3']?>">
                               </div>
                               
                                <div class="col-12 col-md-6 mb-2">
                                   Kategori 5
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori4']?>">
                               </div>
                                <div class="col-12 col-md-6 mb-2">
                                   Kategori 6
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori5']?>">
                               </div>
                               
                                <div class="col-12 col-md-6 mb-2">
                                   Kategori 7
                                   <input type="text" class="form-control" Readonly value="<?=$list['kategori6']?>">
                               </div>
                               ...
                               <div class="col">
                                   <a href="edit_aktivasi?id=<?=$list['id']?>"  class="btn btn-primary mb-2 mt-2">Edit Aktivasi</a>
